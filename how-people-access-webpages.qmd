...
::: {#accessiblity-checklist .callout-tip}
...
-   Have any visuals got the correct alt-text?
:::
...
Given that in the library we are concerned with pages primarily consisting of text and links, the [University of Washington Accessibility Checklist](https://www.washington.edu/accesstech/checklist/) provides more concise guidance, but with more detail than the minimal list at the start of this section.
