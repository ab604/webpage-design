...
A key point is that comparison is often the best way to understand whether we can make a sentence easier to read and more concise.
...
5.  Abstract nouns should be fought like the devil. Compare:
    ...
    > Our exploration of the formualations' implications for readability reveals 
    > that each are unacceptable.
    >
    > We explore what each formulation implies for readability and find 
    > that none are acceptable.
    >
...
Ultimately this is about making you think. You may prefer the more verbose or 
Latin rooted construction, but these 'rules' are to help you think about why a 
sentence will work best for the user.
