...
A chunk, bullet or callout can be considered a unit of information we can hold in our working memory (@sec-working-memory).
...
Use bold font or highlighting text through colour and shape are examples of the vonRostoff
