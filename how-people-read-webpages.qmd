...
People don't read webpages, they scan the page for relevant information. This suggests we should structure our pages, formatting and composing the text, to make scanning easy.
:::
...
@sec-using-imagery-and-visuals discusses how to use imagery and visuals in more detail. A helpful visual is one that imparts information in

### Fonts matter. But not as much as you might think. 
...
1.  To account for individual variation it would be preferable to enable users to choose their own font for reading.
2.  
