...
Users are unlikely to read entire pages, let alone retain the contents, so we need to facilitate their parsing of the constitute parts so they can identify the information relevant to their visit.

This can by done by minimising cognitive load through page structure, well-written content (@sec-how-to-write-for-the-web) and consistency between pages.
